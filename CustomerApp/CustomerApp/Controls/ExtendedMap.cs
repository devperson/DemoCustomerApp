...
namespace CustomerApp.Controls
{
    public class ExtendedMap : Map, INotifyPropertyChanged
    {
        ...
        private async Task<CustomerApp.Controls.PlacesNs.Rootobject> DownloadPlaces(string url)
        {
            var client = new HttpClient();
            var result = await client.GetStringAsync(url);
            return (CustomerApp.Controls.PlacesNs.Rootobject)JsonConvert.DeserializeObject(result, typeof(CustomerApp.Controls.PlacesNs.Rootobject));
        }

        private async Task<CustomerApp.Controls.RoutesNs.Rootobject> DownloadRoutes(string url)
        {
            var client = new HttpClient();
            var result = await client.GetStringAsync(url);
            return (CustomerApp.Controls.RoutesNs.Rootobject)JsonConvert.DeserializeObject(result, typeof(CustomerApp.Controls.RoutesNs.Rootobject));
        }
        ...
        public async Task NearbyLocations(string API_KEY, string types)
        {
            ...
            List<CustomerApp.Controls.PlacesNs.Rootobject> locs = new List<CustomerApp.Controls.PlacesNs.Rootobject>();
